...
const getOperatingSystem = (): 'windows' | 'macos' | 'linux' | 'unknown' => {
...
export default function TitleBar() {
  ...
  useEffect(() => {
    ...
    // Show WCO on Windows/Linux, hide on macOS
    const shouldShowWCO = (os === 'windows' || os === 'linux') && !!wcoSupported;
    setSupportsWCO(shouldShowWCO);
  ...
  return (
    <div className="fixed top-0 left-0 right-0 h-8 bg-[#141414] border-b border-[#454545]/20 flex items-center justify-between z-50 select-none"
      ...
      <div className='absolute left-1/2 flex items-center justify-center -translate-x-1/2'>
      ...
      <div className="flex h-full" style={{ WebkitAppRegion: 'no-drag' } as React.CSSProperties}>
        ...
        {/* WCO - Only show on Windows/Linux */}
        {supportsWCO && (
