...
#define CEF_HELPER_URL "https://github.com/mikofure/hyperion/releases/download/" RELEASE_CHANNEL "/mikowebhelper-win64.zip"
...
public:
  ...
  static std::string GetAppOrigin() { return "miko://app/"; }

  static std::string GetResourcePath() { return "index.html"; }
};
