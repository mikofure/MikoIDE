...
void SimpleApp::OnBeforeCommandLineProcessing(
  ...
  // Disable extensions to prevent Chrome UI interference with keyboard
  // shortcuts
  ...
  command_line->AppendSwitchWithValue(
      "enable-features", "WindowControlsOverlay,WebAppWindowControlsOverlay");
  ...
  command_line->AppendSwitchWithValue(
      "enable-blink-features", "WindowControlsOverlay,CSSEnvironmentVariables");
}
...
void SimpleApp::OnRegisterCustomSchemes(
  ...
  registrar->AddCustomScheme(
      "miko", CEF_SCHEME_OPTION_STANDARD | CEF_SCHEME_OPTION_LOCAL |
                  CEF_SCHEME_OPTION_CORS_ENABLED | CEF_SCHEME_OPTION_SECURE);
}
