...
CefRefPtr<CefDisplayHandler> SimpleClient::GetDisplayHandler() { return this; }

CefRefPtr<CefLifeSpanHandler> SimpleClient::GetLifeSpanHandler() {
  return this;
}

CefRefPtr<CefLoadHandler> SimpleClient::GetLoadHandler() { return this; }

CefRefPtr<CefContextMenuHandler> SimpleClient::GetContextMenuHandler() {
  return this;
}

CefRefPtr<CefDragHandler> SimpleClient::GetDragHandler() { return this; }

CefRefPtr<CefRequestHandler> SimpleClient::GetRequestHandler() { return this; }
        ...
        if (type == "open_menu_overlay") {
          ...
          try {
            ...
            if (height_pos != std::string::npos) {
              ...
              Logger::LogMessage("Received auto height result: " + std::to_string(height));
              ...
              Logger::LogMessage("DEBUG: Missing height field in auto_height_result");
            ...
            Logger::LogMessage("Unknown exception in auto_height_result handler");
