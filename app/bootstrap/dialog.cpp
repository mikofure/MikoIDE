...
LRESULT CALLBACK ModernDialog::WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam,
                                          LPARAM lParam) {
...
bool ModernDialog::Create(HINSTANCE hInstance, HWND hParent,
...
void ModernDialog::UpdateProgress(int percentage, const std::wstring &status,
