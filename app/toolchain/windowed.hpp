...
public:
  ...
  virtual void
  Render(ID2D1RenderTarget *renderTarget, IDWriteTextFormat *textFormat,
         IDWriteTextFormat *boldTextFormat = nullptr,
         IDWriteTextFormat *regularTextFormat = nullptr,
         IDWriteTextFormat *semiboldCenteredTextFormat = nullptr) = 0;
...
public:
  ...
  void Render(ID2D1RenderTarget *renderTarget, IDWriteTextFormat *textFormat,
              IDWriteTextFormat *boldTextFormat = nullptr,
              IDWriteTextFormat *regularTextFormat = nullptr,
              IDWriteTextFormat *semiboldCenteredTextFormat = nullptr) override;
...
public:
  ...
  IDWriteTextFormat *GetCenteredTextFormat() const {
    return m_centeredTextFormat;
  }
  ...
  void SetToolchainSelectedCallback(UIEventCallback callback) {
    m_onToolchainSelected = callback;
  }
  void SetProjectSelectedCallback(UIEventCallback callback) {
    m_onProjectSelected = callback;
  }
  void SetBuildRequestedCallback(std::function<void()> callback) {
    m_onBuildRequested = callback;
  }
  void SetRunRequestedCallback(std::function<void()> callback) {
    m_onRunRequested = callback;
  }
  void SetNewProjectCallback(std::function<void()> callback) {
    m_onNewProject = callback;
  }
  void SetOpenProjectCallback(std::function<void()> callback) {
...
public:
  ...
  void Render(ID2D1RenderTarget *renderTarget, IDWriteTextFormat *textFormat,
              IDWriteTextFormat *boldTextFormat = nullptr,
              IDWriteTextFormat *regularTextFormat = nullptr,
              IDWriteTextFormat *semiboldCenteredTextFormat = nullptr);
  bool HandleEvent(const SDL_Event &event) override;
  void SetOnChangeDirectory(std::function<void()> callback) {
    m_onChangeDirectory = callback;
  }
...
public:
  ...
  void
  SetOnCategorySelected(std::function<void(const std::string &)> callback) {
    m_onCategorySelected = callback;
  }
